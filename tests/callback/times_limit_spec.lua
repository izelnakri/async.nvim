...
describe("Callback.times_limit", function()
  async_it("works normally", function()
    local call_arguments = {}
    Callback.times_limit(5, 2, function(n, next)
  ...
  async_it("works when it has timeout inside", function()
    local call_arguments = {}
    Callback.times_limit(3, 2, function(n, next)
  ...
  async_it("works when times is 0", function()
    local call_arguments = {}
    Callback.times_limit(0, 2, function(n, next)
  ...
  it("can be errored", function()
    Callback.times_limit(5, 2, function(n, callback)
      if n == 3 then
        callback("error", n * 10)
      end
