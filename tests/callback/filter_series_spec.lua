...
describe("Callback.filter_series", function()
  async_it("works on list collection", function()
    Callback.filter_series({ 3, 4, 2, 1 }, function(value, callback, index)
  ...
  async_it("can filter an object correctly", function()
    local me = { name = "Izel", points = 32, last_name = "Nakri", active = true }

    Callback.filter_series(me, function(value, callback)
      Timers.set_timeout(function()
  ...
  async_it("can error", function()
    Callback.filter_series({ 3, 1, 2 }, function(element, callback)
      if element == 1 then
  ...
  it("can be cancelled", function()
    ...
    Callback.filter_series({ 3, 1, 2, 4, 5 }, function(element, callback)
