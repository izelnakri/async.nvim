...
describe("Callback.each_limit", function()
  ...
  it("is with limit that exceeds to size", function()
    local args = {}
  ...
  it("is with limit that equals to size", function()
    local args = {}
    local obj = { a = 1, b = 2, c = 3, d = 4, e = 5 }
  ...
  it("is with no limit(infinity)", function()
    local list = {}
    local count = 0
    for i = 1, 100 do
      table.insert(list, i)
  ...
  it("callback error value", function()
    local obj = { a = 1, b = 2, c = 3, d = 4, e = 5 }
    local call_order = {}
