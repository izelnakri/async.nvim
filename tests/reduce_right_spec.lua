...
describe("Callback.reduce_right", function()
  it("works synchronously", function()
    ...
    Callback.reduce_right({ 2, 4, 5 }, 0, function(result, value, callback, index)
  ...
  it("works when collection is an object instead of a list", function()
    ...
    local call_order = {}
    local operation_result
    Callback.reduce_right(object, { admin = true }, function(result, value, callback, key)
  ...
  it("can handle error", function()
    Callback.reduce_right({ 1, 2, 3 }, 0, function(result, value, callback)
      callback("error")
    end, function(err, b)
  ...
  it("can handle cancel case", function(done)
    local call_order = {}
    Callback.reduce_right({ 3, 5, 2 }, 0, function(result, value, callback, index)
      table.insert(call_order, value)
      if index == 2 then
