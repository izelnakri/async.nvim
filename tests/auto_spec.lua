...
describe("Callback.auto", function()
  ...
  it("works for a basic case", function(done)
    local call_order = {}
  ...
  it("auto concurrency no callback", function()
    Callback.auto({
      task1 = function(callback)
        callback()
      end,
  ...
  it("auto error should pass partial results", function()
    Callback.auto({
      task1 = function(callback)
  ...
  it("auto calls callback multiple times with parallel functions", function()
    Callback.auto(
      {
        task1 = function(callback)
          Timers.set_timeout(function()
  ...
  it("auto modifying results causes final callback to run early", function()
    Callback.auto({
      task1 = function(callback)
        callback(nil, "task1")
      end,
  ...
  it("auto stops running tasks on error", function()
    Callback.auto(
      {
        task1 = function(callback)
          callback("error")
  ...
  it("ignores results after an error", function()
    Callback.auto({
      task1 = function(callback)
        Timers.set_timeout(function()
          callback("error")
