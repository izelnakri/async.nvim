...
---Runs a **truth test function** to every element inside the collection **in series**. **Stops the iteration when you pass falsy value inside iteratee**. **Errors may stop the iteration early**.
